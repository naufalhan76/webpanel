  ...
  return (
    <div className="space-y-4 md:space-y-6 p-4 md:p-0">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl md:text-3xl font-bold">Accept Order</h1>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Terima atau tolak order baru yang masuk
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="min-w-[120px]">Jadwal</TableHead>
              ...
              <TableBody>
                <TableRow>
                  <TableCell colSpan={7} className="text-center text-muted-foreground">
                    Tidak ada order baru yang perlu dikonfirmasi.
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
